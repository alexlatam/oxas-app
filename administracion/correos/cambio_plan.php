<?php
/*Definiciones previas impotantes - IMPORTANTE
Destinataio: perosna que se le enviaran el correos
plan= nombre del nuevo plan al cual se esta haciendo el cambio.
*/
...
$asunto = "Has Cambiado Tu plan en Oxasapp";
$cuerpo = '<!doctype html>
<html xmlns="http://www.w3.org/1999/xhtml" xmlns:v="urn:schemas-microsoft-com:vml" xmlns:o="urn:schemas-microsoft-com:office:office">
	...
	*/
		#templateHeader{
			...
			/*@editable*/background-image:url("https://gallery.mailchimp.com/b6bff115451559994233ed972/images/fd118c32-f06c-4356-8644-5bf916a2a2a0.jpg");
			/*@editable*/background-repeat:no-repeat;
			/*@editable*/background-position:center;
			/*@editable*/background-size:contain;
			/*@editable*/border-top:0;
			/*@editable*/border-bottom:0;
			/*@editable*/padding-top:87px;
			/*@editable*/padding-bottom:87px;
		}
	/*
	@tab Header
...
<p>Hemos recibido un cambio de plan en tu cuenta de Oxasapp, Tu&nbsp; Nuevo plan es&nbsp; '.strtoupper($plan).'.<br>
<br>
Ten en cuenta que este plan sera activado, luego de ser aprobado el pago respectivo que cubre los servicios del Nuevo plan. Por otro lado, Tu plan anterior estará activo hasta la próxima fecha de vencimiento.<br>
<br>
&nbsp;Si tienes dudas sobre el cambio, No dudes en contactarnos.</p>
...
try {
    ...
    $mail->addAddress($destinatario, 'Cliente');     // Add a recipient             // Name is optional
