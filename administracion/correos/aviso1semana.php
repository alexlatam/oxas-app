...
$asunto = "Tu Plan Vence en una Semana";
$cuerpo = '<!doctype html>
                ...
                <table align="left" border="0" cellpadding="0" cellspacing="0" style="max-width:100%; min-width:100%;" width="100%" class="mcnTextContentContainer">
                    <tbody><tr>
                        ...
                        <td valign="top" class="mcnTextContent" style="padding-top:0; padding-right:18px; padding-bottom:9px; padding-left:18px;">
                            ...
                            <h3>¡Tu&nbsp;fecha de vencimiento se&nbsp;acerca!</h3>

<p>Te informamos que tu fecha de vencimiento es el próximo <strong>'.$fechaV.'</strong>, Te recomendamos realizar el pago para seguir disfrutando de los beneficios de OxasApp.&nbsp;<br>
<br>
