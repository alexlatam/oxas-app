...
$asunto = "Importante, Tu plan de Oxasapp ha vencido";
$cuerpo = '<!doctype html>
<html xmlns="http://www.w3.org/1999/xhtml" xmlns:v="urn:schemas-microsoft-com:vml" xmlns:o="urn:schemas-microsoft-com:office:office">
	...
	*/
		#templateHeader{
			...
			/*@editable*/background-image:url("https://gallery.mailchimp.com/b6bff115451559994233ed972/images/842006e1-0fbd-4d54-9362-98c67c32fe52.jpg");
                ...
                <table align="left" border="0" cellpadding="0" cellspacing="0" style="max-width:100%; min-width:100%;" width="100%" class="mcnTextContentContainer">
                    <tbody><tr>
                        ...
                        <td valign="top" class="mcnTextContent" style="padding-top:0; padding-right:18px; padding-bottom:9px; padding-left:18px;">
                            ...
                            <h3>¡Tu cuenta de Oxasapp esta vencida!</h3>

<p>Tu cuenta ha sido suspendida,&nbsp;Todas las herramientas de Oxasapp han sido deshabilitadas.&nbsp;Para seguir disfrutando de los beneficios de oxasapp, debes realizar el pago de tu plan.<br>
&nbsp;<br>
