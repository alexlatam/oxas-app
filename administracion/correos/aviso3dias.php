...
$asunto = "Tu Plan Vence en tres Dias";
$cuerpo = '<!doctype html>
<html xmlns="http://www.w3.org/1999/xhtml" xmlns:v="urn:schemas-microsoft-com:vml" xmlns:o="urn:schemas-microsoft-com:office:office">
	...
	*/
		#templateHeader{
			...
			/*@editable*/background-image:url("https://gallery.mailchimp.com/b6bff115451559994233ed972/images/66e98b88-e514-4342-927d-293e3bdc0811.jpg");
                ...
                <table align="left" border="0" cellpadding="0" cellspacing="0" style="max-width:100%; min-width:100%;" width="100%" class="mcnTextContentContainer">
                    <tbody><tr>
                        ...
                        <td valign="top" class="mcnTextContent" style="padding-top:0; padding-right:18px; padding-bottom:9px; padding-left:18px;">
                            ...
                            <h3>¡Tu&nbsp;fecha de vencimiento es muy&nbsp;cerca!</h3>

<p>Te informamos que tu fecha de vencimiento es el próximo <strong>10/10/2019</strong>,&nbsp; por lo que te quedan tres (3) días. Te recomendamos realizar el pago lo mas pronto posible para seguir disfrutando de los beneficios de OxasApp.&nbsp;<br>
<br>
Para realizar un pago ve a la opción de suscripción, Selecciona el botón Pagar y sigue los pasos.<br>
<br>
&nbsp;Si tienes dudas sobre como pagar, No dudes en contactarnos.</p>
