...
if(isset($_GET['item'])){
$item=$_GET['item'];$url="https://api.mercadolibre.com/items/".$item."/visits/time_window?last=".$last."&unit=".$unit."&ending=".$ending;
}elseif(isset($_GET['seller'])){
$seller=$_GET['seller'];$url='https://api.mercadolibre.com/users/'.$seller.'/items_visits/time_window?last='.$last.'&unit='.$unit.'&ending='.$ending;
}
