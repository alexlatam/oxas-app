...
$maximo=0;$mes=$_GET['mes'];$anio=$_GET['anio'];$item=$_GET['item'];if($mes=='Dic'){$anio=(int)$anio+1;}
$unit='day';$meses=array("Ene","Feb","Mar","Abr","May","Jun","Jul","Ago","Sep","Oct","Nov","Dic");
$diasMeses=array(31,28,31,30,31,30,31,31,30,31,30,31);$numMeses=array('01','02','03','04','05','06','07','08','09','10','11','12');
$last=$diasMeses[array_search($mes,$meses)];
if($mes=='Dic'){$ending=$anio.'-01-01';}else{$ending=$anio.'-'.$numMeses[(array_search($mes,$meses)+1)].'-01';}
$url="https://api.mercadolibre.com/items/".$item."/visits/time_window?last=".$last."&unit=".$unit."&ending=".$ending;
...
$totales=$consulta->total_visits;$resultados=$consulta->results;
...
array_push($array_dia,$dia_aux);array_push($array_cant,$cantidad);//agrego el total
}
