    ...
    <div class='container-fluid'>
      ...
      <div class="container">
        <div class="row">
          ...
          <?php endif; ?>
          <?php
          $sql = "SELECT se.IDSERVICIOS,se.IDPLAN FROM suscripcion s INNER JOIN servicios se ON s.user_id=se.user_id WHERE s.user_id='$id_user' LIMIT 1";
          $r = $conn->query($sql);
          if ($r->num_rows > 0) {
            $row = $r->fetch_assoc();
            $id_plan = $row['IDPLAN'];
          ...
          ?>
              ...
              <script>
                $("button#ok<?= $row['IDPLAN'] ?>").click(function() {
                  $.get("cambio-suscripcion.php", {
                    idplan: <?= $row['IDPLAN'] ?>,
                    idservicio: <?= $id_servicios ?>
                  }, verificar);
                  ...
                  function verificar(valor) {
                    if (valor == 1) {
                      ...
                      toast({
                        type: 'success',
                        titleText: '¡Has cambiado de plan de manera exitosa!'
                      });
                      ...
                      toast({
                        type: 'danger',
                        titleText: '¡Has ocurido un error al cambiar de suscripción. \n Por favor, ¡intentelo nuevamente!'
                      });
                    }
                  }
                });
