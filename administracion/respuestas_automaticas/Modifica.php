...
if (isset($_GET['modifica'])) {
  ...
  if ($mod != NULL) {
    ...
    #Leer respuesta
    $sql = "SELECT `IDSINAPSIS`,`user_id`,`INFO`,`NUMPUBLICACIONES`,`ESTIMULOS` FROM `sinapsis` WHERE `IDSINAPSIS`=$mod LIMIT 1;";
            ...
            <div class='col-sm-4'>
              <div class='container-fluid overflow bg-light border rounded' id='publicaciones_activas'>
                ...
                <div class='row align-items-center pt-2 justify-content-center'>
                  <label class='switch'>
                    <input type='checkbox' name='' id='selectall' <?php if ($items == $n_p) {
                                                                    echo 'checked';
                                                                  } ?>>
                          ...
                          <div class='row align-items-center'>
                            <div class='col-sm-2 text-center'>
                              <label class='switch public'>
                                <input type='checkbox' name='publicaciones' value="<?php echo $valor->id . '~¬' . $valor->title ?>" <?php
