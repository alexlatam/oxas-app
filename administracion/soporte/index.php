...
?>
<div class='row border-botton pl-2 align-items-center m-0 py-1'>
<div class='public'>
<?php
if(isset($_SESSION['array_publicaciones'][0]) && $_SESSION['array_publicaciones'][0]==1 && !in_array($id,$_SESSION['array_publicaciones'])){
?>
...
<div class='col-auto mr-auto cursor-pointer' data-toggle='modal' data-target='.images-<?php echo $id?>-modal-lg' id='images<?php echo $id?>'>
<img class='img-fluid img-thumbnail' src='<?php echo $thumbnail;?>' width='40px' height='40px' title='Imagen publicación' data-toggle='tooltip'>
</div>
<div class='col-6 mr-auto' id="cont_title<?php echo $id?>">
<span class='cursor-pointer' data-toggle='modal' data-target='#quantity<?php echo $id?>'>
(<b class='text-success' title='Stock' data-toggle='tooltip' id='stock_real<?php echo $id?>'><?php echo $quantity;?></b>)
</span>
<input class='cursor-pointer input_title text-primary' type="text" value="<?php echo $title;?>" id='titulo<?php echo $id?>'>
</div>
<div class='col-sm-2 text-center text-primary' id="cont_precio<?php echo $id?>">
...
<div class='col-sm-1 text-center text-success cursor-pointer' data-toggle='modal' data-target='.res-<?=$id?>-modal-lg' id='cant_respuestas<?=$id?>'>
...
$.get('images.php',{item:'<?php echo $id?>'},verificar,'json');
...
if(typeof $("span.auxiliar").val()!=='undefined'){$('span.auxiliar').each(function(){var aux=$(this).remove();});$("span.auxiliar").remove();}
$("#cont_title<?php echo $id?>").append("<span class='auxiliar'>"+aux1+aux2+"</span>");
}
});
$(document).on('click','#cancelar_title<?php echo $id?>',function(){$('#actualizartitle<?php echo $id?>').remove();$('#cancelar_title<?php echo $id?>').remove();});
$(document).on('click','#actualizartitle<?php echo $id?>',function(){
var id="<?php echo $id?>", title=$("#titulo<?php echo $id?>").val();
$.ajax({url:'title.php',type:'GET',data:{item:id,title:title},async:false,dataType:'json',
...
$.ajax({url:'stock.php',type:'GET',data:{item:id,quantity:quantity,band:band,origin:origin},async:false,dataType:'json',
success: function(json){
...
$.ajax({url:'cantidad_respuestas.php',type:'GET',data:{item:id},async:false,dataType:'text',
...
$.ajax({url:'price.php',type:'GET',data:{item:id,price:price},async:false,dataType:'json',
success: function(json){
...
$.ajax({url:'pausar.php',type:'GET',data:{item:items,band:band},async:false,dataType:'json',
success: function(json){
...
$.ajax({url:'edit_description.php',type:'GET',data:{item:"<?php echo $id?>",text:text},async:false,dataType:'json',
success: function(json){
...
$.get("historial.php",{item:"<?php echo $id?>"},verificar,'json');
function verificar(respuesta){
...
var cat='<?php echo $categoria;?>', url='https://api.mercadolibre.com/sites/MLV/trends/search?category='+cat;
$.getJSON(url,function(datos){
...
$.get('pausar.php',{band:band},verificar,'text');
function verificar(respuesta){
if(respuesta!=''){
...
$.get('stock.php',{stock:stock,condicion:condicion,band:band,origin:origin},verificar,'text');
function verificar(respuesta){
