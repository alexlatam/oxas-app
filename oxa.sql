...
CREATE TABLE publicacion (
    IDPUBLICACION INT(11) AUTO_INCREMENT,
    IDUSUARIO INT(25),
    CODIGO VARCHAR(25),
...
ALTER TABLE `sinapsis`
  ADD CONSTRAINT `sinapsis_ibfk_1` FOREIGN KEY (`IDUSUARIO`) REFERENCES `usuario` (`IDUSUARIO`) ON DELETE CASCADE;

ALTER TABLE `suscripcion`
  ADD CONSTRAINT `suscripcion_ibfk_1` FOREIGN KEY (`IDUSUARIO`) REFERENCES `usuario` (`IDUSUARIO`) ON DELETE CASCADE;
COMMIT;
